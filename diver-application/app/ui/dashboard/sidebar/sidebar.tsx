...
export default function Sidebar() {
  ...
  {/* Sidebar */}
  <div
    className={`fixed top-16 left-0 h-[calc(100%-56px)] w-64 md:w-72 flex flex-col text-black z-50 
    transition-transform  ease-in-out bg-[#001526] rounded-tr-3xl overflow-y-auto 
    ${isOpen ? "translate-x-0" : "-translate-x-full md:translate-x-0"}`}
  >
    {/* Sidebar Menu */}
    <div className="mt-8 p-4 rounded-t-3xl ">
      <ul>
