...
export default function Card() {
  return (
    <div className="bg-[#2C7DA0] text-white p-8 rounded-lg shadow-md w-full mt-6 grid grid-cols-2">
        <div>
            ...
            <a href="/dashboard/DiveManagement">
              <button>
                <p className="text-sm text-white bg-[#001526] rounded-lg p-4 text-center px-3 w-full font-semibold">Check Dive Logs →</p>
              </button>
            </a>
        </div>
