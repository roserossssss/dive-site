...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      <div
        className={`fixed top-0 left-0 w-72 bg-[#001526] p-4 pb-8 flex items-center justify-center transition-transform duration-300 ease-in-out 
      ...
      >
        ...
        <div className="bg-[#FDFDFD] w-full h-[4.9rem] relative">
          <Link href="/Admin-Dashboard/ProfilePage/ProfileSettings">
