      ...
      <div className="mt-6 bg-[#2E6782] p-6 rounded-t-3xl">
        <div className="flex flex-col items-center">
          <div className="w-[200px] h-[310px] flex items-center justify-center bg-transparent">
            <img src="/image-upload.svg" alt="Upload" className="w-[270px] h-[270px] -mt-6" />
          </div>
          <p className="text-white text-sm -mt-12">Maximum of 5MB</p>
          <p className="text-white text-sm">JPEG, PNG, JPEG, PDF</p>
