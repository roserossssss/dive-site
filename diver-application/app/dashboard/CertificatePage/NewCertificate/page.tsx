    ...
    <div className="flex-1 p-5 pt-2 relative">
      ...
      <div className="flex justify-end gap-4 mt-6">
        <button
          ...
          className="w-[230px] h-[60px] px-9 py-2 font-semibold text-xl bg-gray-300 text-[#001526] rounded-full"
        >
          Cancel
        </button>
        <button
      ...
      <div className="bg-[#D9E7EC] p-10 rounded-b-3xl h-[400px]">
        <h3 className="text-3xl font-bold text-[#001526] mb-4">Certification Details</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          ...
          <div className="flex flex-col">
            ...
            <input
              ...
              onChange={handleChange}
              className="bg-transparent border-[#001526] border p-3 rounded-lg w-full"
            />
          </div>
        </div>
      </div>
