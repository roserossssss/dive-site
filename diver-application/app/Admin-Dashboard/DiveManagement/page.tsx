...
const dives = [
  ...
  },
  {
    userId: "ML0010",
    name: "Gray Yeon",
    title: "Coral Exploration",
    dateLogged: "2025-03-01",
  },
  {
    userId: "ML0011",
    name: "Chris Brown",
      ...
      >
        {diveRecords.length > 0 ? (
          <div
            ...
            style={{ maxWidth: "100vw" }} // Ensure it fits within the viewport
          >
            <table className="w-full text-center text-[#001526] mt-1 table-auto sm:table-fixed text-xs sm:text-sm md:text-base">
              <thead className="bg-[#D9E7EC] border-b-2 border-gray-400">
                <tr>
                  <th className="pl-4 sm:pl-10 pr-0 py-4 w-8 sm:w-12 text-left">
                    <input
                      type="checkbox"
                  ...
                  <th className="px-2 sm:px-4 py-4 font-semibold text-xs sm:text-sm md:text-base w-[80px] sm:w-[140px]">
                    Date Logged
                  </th>
                  <th className="pr-2 sm:pr-4 pl-0 py-4 font-semibold text-xs sm:text-sm md:text-base w-[30px] text-right"></th>
                </tr>
              </thead>
