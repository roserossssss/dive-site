...
interface AccountTypeChangeModalProps {
  isVisible: boolean;
  onClose: () => void;
  onConfirm: () => void;
  accountType: string;
...
export default function AccountTypeChangeModal({
  isVisible,
  onClose,
  onConfirm,
  accountType,
}: AccountTypeChangeModalProps) {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-[9999]">
      <div className="bg-[#D9E7EC] p-8 w-11/12 sm:w-[480px] h-auto sm:h-[450px] rounded-2xl shadow-lg flex flex-col justify-center items-center">
        ...
        <p className="font-semibold text-center text-[#001526] mb-5 text-[15px]">
          Are you sure you want to change <br /> the account type of this user?
        </p>
